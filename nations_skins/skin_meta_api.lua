...
function skins.new(key, object)
	assert(key, 'Unique skins key required, like "nskins_1"')
...
function skin_class:apply_skin_to_player(player)
	...
	player_api.set_model(player, "nations_skins_3d_armor_nskins_5.b3d")
...
function skin_class:set_skin(player)
	...
	-- See nskins_creator for example
end
